...
@Observable
class AppModel {
    private(set) var authorizationStatus: ARKitSession.AuthorizationStatus?
    var presentPanel: 🛠️Panel? = nil
    var selectedLeft: Bool = false
    var selectedRight: Bool = false
